...
Sub DetallesProducto()
	...
	If JavaWindow("Ejecutivo de interacción").JavaMenu("Acciones").JavaMenu("Pedidos").JavaMenu("Cambiar").GetROProperty("enabled") = "1" Then
...
Sub ActualizarAtributos()
	...
	While((JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaButton("Siguiente >").Exist)Or(JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Parametriza el Usuario").JavaRadioButton("Contacto por Defecto").Exist))=False
		wait 1
	Wend
	
	If JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Parametriza el Usuario").JavaRadioButton("Contacto por Defecto").Exist Then
		JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Parametriza el Usuario").JavaRadioButton("Contacto por Defecto").Set
		wait 1
		JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &Num_Iter&"_"&"ParametrizaUsuario"&".png", True
		imagenToWord "Parametriza el Usuario", RutaEvidencias() &Num_Iter&"_"&"ParametrizaUsuario"&".png"
		JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Parametriza el Usuario").JavaButton("Siguiente >").Click
	End If
...
Sub NegociarConfiguracion()
	...
	wait 1
		...
		tiempo=0
			...
			End If
			wait 1
		Loop  While Not (varasig2="1")
	
	If JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaButton("Distribuir Número").Exist Then
		JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaButton("Distribuir Número").Click
		wait 1
	End If
	JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &Num_Iter&"_"&"Número_Telefónico_"&".png", True
	imagenToWord "Nuevo Número de Telefóno", RutaEvidencias() &Num_Iter&"_"&"Número_Telefónico_"&".png"
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Configuración").JavaTable("SearchJTable").Output CheckPoint("SearchJTable") @@ hightlight id_;_23950704_;_script infofile_;_ZIP::ssf4.xml_;_
	wait 1
	...
	While((JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Resumen de la orden (Orden").JavaButton("Validar y Ver Contrato").Exist) Or (JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Distribución").JavaEdit("Nombre y Dirección de").Exist)) = False
		wait 1
	Wend
	...
	ElseIf JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Resumen de la orden (Orden").JavaButton("Validar y Ver Contrato").Exist = true Then
		Call ResumenOrden()
	End If
...
End Sub
Sub NegociarPago()
	While JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Pago (Orden 1036653A").JavaEdit("ID del cliente:").Exist = false
		wait 1
	Wend
	text = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Pago (Orden 1036653A").JavaEdit("ID del cliente:").GetROProperty("text")
	While text = ""
		wait 1
		text = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Pago (Orden 1036653A").JavaEdit("ID del cliente:").GetROProperty("text")
	Wend
	...
	JavaWindow("Ejecutivo de interacción_2").JavaInternalFrame("Negociar Pago (Orden 1036653A").JavaButton("Límite de Compra").Click
	wait 5
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Pago (Orden 1036653A").JavaButton("Pago inmediato").Click
	While JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Pago Inmediato").JavaEdit("BAR ID").Exist = false
		wait 1
	Wend
	texto = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Pago Inmediato").JavaEdit("BAR ID").GetROProperty("text")
	While texto = ""
		wait 1
		texto = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Pago Inmediato").JavaEdit("BAR ID").GetROProperty("text")
	Wend
	wait 1
	RUC = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Pago Inmediato").JavaEdit("Numero RUC").GetROProperty("text")
	If RUC <> "" Then
	...
	wait 1 
	JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &"PagoInmediato.png", True
	imagenToWord "Pago Inmediato", RutaEvidencias() &"PagoInmediato.png"
	wait 1
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Pago Inmediato").JavaButton("Enviar").Click
	While JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Pago (Orden 1036653A").JavaButton("Cancelar pago inmediato").Exist = false
		wait 1
	Wend
	JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &"NegociarPagoT.png", True
	imagenToWord "Negociar Pago Culminado", RutaEvidencias() &"NegociarPagoT.png"
	JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Pago (Orden 1036653A").JavaButton("Siguiente >").Click
...
'					JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &Num_Iter&"_"&"ErrorNegociar Distribución", True
'					imagenToWord "No cargó la pantalla -Negociar Distribución- de manera correcta",RutaEvidencias() &Num_Iter&"_"&"ErrorNegociar Distribución"
'					Reporter.ReportEvent micFail, DataTable("s_Resultado", dtLocalSheet), DataTable("s_Detalle", dtLocalSheet)
'					ExitActionIteration
'					End If
'					wait 1
'			Loop While Not JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Distribución").JavaEdit("Nombre y Dirección de").Exist
		Dim txt
		txt = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Distribución").JavaEdit("Nombre y Dirección de").GetROProperty("text")
		While txt = ""
			wait 1
			txt = JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Distribución").JavaEdit("Nombre y Dirección de").GetROProperty("text")
		Wend
		...
		wait 5
		JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &Num_Iter&"_"&"NegociarDistribución.png", True
		imagenToWord "Negociar Distribución", RutaEvidencias() &Num_Iter&"_"&"NegociarDistribución.png"
		JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Distribución").JavaButton("Siguiente >").Click
		
		While ((JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Resumen de la orden (Orden").JavaButton("Validar y Ver Contrato").Exist) or (JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Pago (Orden 1036653A").JavaEdit("ID del cliente:").Exist)) = False
		
			wait 1
		Wend
		If JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Resumen de la orden (Orden").JavaButton("Validar y Ver Contrato").Exist = True Then
			Call ResumenOrden()
		 ElseIf JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Negociar Pago (Orden 1036653A").JavaEdit("ID del cliente:").Exist = True Then
		 	Call  NegociarPago()
		 	Call ResumenOrden()
		End If
...
RunAction "WIC_2", oneIteration
	...
	If JavaWindow("Ejecutivo de interacción").JavaDialog("Resumen de la orden (Orden").Exist(2) Then
		...
		Wait 1
		checkhab=JavaWindow("Ejecutivo de interacción").JavaInternalFrame("Resumen de la orden (Orden").JavaCheckBox("El cliente firmó.").GetROProperty("enabled")
		If checkhab="1" Then
...
Sub EmpujeOrden()
	...
	If DataTable("e_Usuario", "Login") = "CC_DLW" Then
		
		RunAction "LoginEmpOrd", oneIteration
	...
	If str_TipoData = "DATA LOGICA" Then
		...
		JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &"DepositoOrdenes.png", True
		imagenToWord "Depósito de Órdenes",RutaEvidencias() &"DepositoOrdenes.png"
		...
		Wait 2
		JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &"GestionManual.png", True
		imagenToWord "Estado de la gestión manual- de manera correcta",RutaEvidencias() & "GestionManual.png"
...
Sub BuscarOrden()
	...
	Wait 8
		...
		JavaWindow("Ejecutivo de interacción").CaptureBitmap RutaEvidencias() &"OrdenCerrada.png", True
		imagenToWord "Se realizó el Cambio de Número Correctamente",RutaEvidencias() &"OrdenCerrada.png"
